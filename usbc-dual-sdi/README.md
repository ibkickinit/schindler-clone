...
- [`docs/07-sourcing-playbook.md`](docs/07-sourcing-playbook.md) — **how to actually source the MST front end** (ease ranking + the one recommended prototype + production path).
