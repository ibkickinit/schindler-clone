...
static void cmd_help(void)
{
    xil_printf("\r\nUART commands — color pipeline:\r\n"
               ...
               "  J <json>        JSON-RPC 2.0 (catalog; for schindlerd)\r\n");
}
 ...
 * carryover smear).
 *
 * Cross-branch note (mackin): same helper used on iter5-1080p-clean to
 * localize the H-shift to scaler_h's MAC window. iter12+13 verification
 * pattern is row N's HEAD col 0 == source col 0 (left vline at half-bright
 * after iter12), TAIL col 1279 == source col 1919 (right vline at half-bright). */
