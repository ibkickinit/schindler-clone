...
module pg_tsg #(
    ...
    // ---- text banner overlay ("EDGERLY TSG") so the pattern can't be mistaken for a
    ...
    initial begin
        ...
        txt_mem[ 24] = 32'h00003fff;
        txt_mem[ 25] = 32'h87fe0000;
        txt_mem[ 26] = 32'h7e01fffc;
        txt_mem[ 27] = 32'h1ffc007c;
        txt_mem[ 28] = 32'h003f007e;
        txt_mem[ 29] = 32'h000007ff;
        txt_mem[ 30] = 32'hfc03f800;
        txt_mem[ 31] = 32'h07e00000;
        txt_mem[ 32] = 32'h00003fff;
        txt_mem[ 33] = 32'h87ff8001;
        txt_mem[ 34] = 32'hff81fffc;
        txt_mem[ 35] = 32'h1fff807c;
        txt_mem[ 36] = 32'h001f007c;
        txt_mem[ 37] = 32'h000007ff;
        txt_mem[ 38] = 32'hfc0ffe00;
        txt_mem[ 39] = 32'h1ff80000;
        txt_mem[ 40] = 32'h00003fff;
        txt_mem[ 41] = 32'h87ffe007;
        txt_mem[ 42] = 32'hffc1fffc;
        txt_mem[ 43] = 32'h1fffc07c;
        txt_mem[ 44] = 32'h001f80fc;
        txt_mem[ 45] = 32'h000007ff;
        txt_mem[ 46] = 32'hfc1fff00;
        txt_mem[ 47] = 32'h7ffc0000;
        txt_mem[ 48] = 32'h00003fff;
        txt_mem[ 49] = 32'h87fff00f;
        txt_mem[ 50] = 32'hffc1fffc;
        txt_mem[ 51] = 32'h1fffc07c;
        txt_mem[ 52] = 32'h000f80f8;
        txt_mem[ 53] = 32'h000007ff;
        txt_mem[ 54] = 32'hfc3fff00;
        txt_mem[ 55] = 32'hfffc0000;
        txt_mem[ 56] = 32'h00003e00;
        txt_mem[ 57] = 32'h07c3f00f;
        txt_mem[ 58] = 32'hc1c1f000;
        txt_mem[ 59] = 32'h1f07e07c;
        txt_mem[ 60] = 32'h000fc1f8;
        txt_mem[ 61] = 32'h0000001f;
        txt_mem[ 62] = 32'h007e0f00;
        txt_mem[ 63] = 32'hfc1c0000;
        txt_mem[ 64] = 32'h00003e00;
        txt_mem[ 65] = 32'h07c1f81f;
        txt_mem[ 66] = 32'h8041f000;
        txt_mem[ 67] = 32'h1f03e07c;
        txt_mem[ 68] = 32'h0007c1f0;
        txt_mem[ 69] = 32'h0000001f;
        txt_mem[ 70] = 32'h007c0301;
        txt_mem[ 71] = 32'hf8040000;
        txt_mem[ 72] = 32'h00003e00;
        txt_mem[ 73] = 32'h07c0f81f;
        txt_mem[ 74] = 32'h0001f000;
        txt_mem[ 75] = 32'h1f03e07c;
        txt_mem[ 76] = 32'h0007e3f0;
        txt_mem[ 77] = 32'h0000001f;
        txt_mem[ 78] = 32'h007c0101;
        txt_mem[ 79] = 32'hf0000000;
        txt_mem[ 80] = 32'h00003e00;
        txt_mem[ 81] = 32'h07c0f81f;
        txt_mem[ 82] = 32'h0001f000;
        txt_mem[ 83] = 32'h1f03e07c;
        txt_mem[ 84] = 32'h0003e3e0;
        txt_mem[ 85] = 32'h0000001f;
        txt_mem[ 86] = 32'h007c0001;
        txt_mem[ 87] = 32'hf0000000;
        txt_mem[ 88] = 32'h00003e00;
        txt_mem[ 89] = 32'h07c07c3e;
        txt_mem[ 90] = 32'h0001f000;
        txt_mem[ 91] = 32'h1f03e07c;
        txt_mem[ 92] = 32'h0003f7e0;
        txt_mem[ 93] = 32'h0000001f;
        txt_mem[ 94] = 32'h007e0003;
        txt_mem[ 95] = 32'he0000000;
        txt_mem[ 96] = 32'h00003e00;
        txt_mem[ 97] = 32'h07c07c3e;
        txt_mem[ 98] = 32'h0001f000;
        txt_mem[ 99] = 32'h1f03e07c;
        txt_mem[100] = 32'h0001f7c0;
        txt_mem[101] = 32'h0000001f;
        txt_mem[102] = 32'h007f8003;
        txt_mem[103] = 32'he0000000;
        txt_mem[104] = 32'h00003fff;
        txt_mem[105] = 32'h07c07c3e;
        txt_mem[106] = 32'h0001fff8;
        txt_mem[107] = 32'h1f07c07c;
        txt_mem[108] = 32'h0000ff80;
        txt_mem[109] = 32'h0000001f;
        txt_mem[110] = 32'h003ff003;
        txt_mem[111] = 32'he0000000;
        txt_mem[112] = 32'h00003fff;
        txt_mem[113] = 32'h07c07c3e;
        txt_mem[114] = 32'h0001fff8;
        txt_mem[115] = 32'h1fffc07c;
        txt_mem[116] = 32'h0000ff80;
        txt_mem[117] = 32'h0000001f;
        txt_mem[118] = 32'h001ffc03;
        txt_mem[119] = 32'he0000000;
        txt_mem[120] = 32'h00003fff;
        txt_mem[121] = 32'h07c07c3e;
        txt_mem[122] = 32'h0fe1fff8;
        txt_mem[123] = 32'h1fff007c;
        txt_mem[124] = 32'h00007f00;
        txt_mem[125] = 32'h0000001f;
        txt_mem[126] = 32'h000ffe03;
        txt_mem[127] = 32'he0fe0000;
        txt_mem[128] = 32'h00003fff;
        txt_mem[129] = 32'h07c07c3e;
        txt_mem[130] = 32'h0fe1fff8;
        txt_mem[131] = 32'h1ffe007c;
        txt_mem[132] = 32'h00007f00;
        txt_mem[133] = 32'h0000001f;
        txt_mem[134] = 32'h0003ff03;
        txt_mem[135] = 32'he0fe0000;
        txt_mem[136] = 32'h00003e00;
        txt_mem[137] = 32'h07c07c3e;
        txt_mem[138] = 32'h0fe1f000;
        txt_mem[139] = 32'h1fff007c;
        txt_mem[140] = 32'h00003e00;
        txt_mem[141] = 32'h0000001f;
        txt_mem[142] = 32'h00007f03;
        txt_mem[143] = 32'he0fe0000;
        txt_mem[144] = 32'h00003e00;
        txt_mem[145] = 32'h07c07c3e;
        txt_mem[146] = 32'h0fe1f000;
        txt_mem[147] = 32'h1f1f807c;
        txt_mem[148] = 32'h00003e00;
        txt_mem[149] = 32'h0000001f;
        txt_mem[150] = 32'h00001f83;
        txt_mem[151] = 32'he0fe0000;
        txt_mem[152] = 32'h00003e00;
        txt_mem[153] = 32'h07c07c3e;
        txt_mem[154] = 32'h01e1f000;
        txt_mem[155] = 32'h1f0f807c;
        txt_mem[156] = 32'h00003e00;
        txt_mem[157] = 32'h0000001f;
        txt_mem[158] = 32'h00000f83;
        txt_mem[159] = 32'he01e0000;
        txt_mem[160] = 32'h00003e00;
        txt_mem[161] = 32'h07c0f81f;
        txt_mem[162] = 32'h01e1f000;
        txt_mem[163] = 32'h1f0fc07c;
        txt_mem[164] = 32'h00003e00;
        txt_mem[165] = 32'h0000001f;
        txt_mem[166] = 32'h00000f81;
        txt_mem[167] = 32'hf01e0000;
        txt_mem[168] = 32'h00003e00;
        txt_mem[169] = 32'h07c0f81f;
        txt_mem[170] = 32'h01e1f000;
        txt_mem[171] = 32'h1f07c07c;
        txt_mem[172] = 32'h00003e00;
        txt_mem[173] = 32'h0000001f;
        txt_mem[174] = 32'h00400f81;
        txt_mem[175] = 32'hf01e0000;
        txt_mem[176] = 32'h00003e00;
        txt_mem[177] = 32'h07c1f81f;
        txt_mem[178] = 32'h81e1f000;
        txt_mem[179] = 32'h1f07c07c;
        txt_mem[180] = 32'h00003e00;
        txt_mem[181] = 32'h0000001f;
        txt_mem[182] = 32'h00600f81;
        txt_mem[183] = 32'hf81e0000;
        txt_mem[184] = 32'h00003e00;
        txt_mem[185] = 32'h07c3f00f;
        txt_mem[186] = 32'hc1e1f000;
        txt_mem[187] = 32'h1f03e07c;
        txt_mem[188] = 32'h00003e00;
        txt_mem[189] = 32'h0000001f;
        txt_mem[190] = 32'h00781f80;
        txt_mem[191] = 32'hfc1e0000;
        txt_mem[192] = 32'h00003fff;
        txt_mem[193] = 32'h87fff00f;
        txt_mem[194] = 32'hffe1fffc;
        txt_mem[195] = 32'h1f03e07f;
        txt_mem[196] = 32'hff003e00;
        txt_mem[197] = 32'h0000001f;
        txt_mem[198] = 32'h007fff00;
        txt_mem[199] = 32'hfffe0000;
        txt_mem[200] = 32'h00003fff;
        txt_mem[201] = 32'h87ffe007;
        txt_mem[202] = 32'hffe1fffc;
        txt_mem[203] = 32'h1f01f07f;
        txt_mem[204] = 32'hff003e00;
        txt_mem[205] = 32'h0000001f;
        txt_mem[206] = 32'h007fff00;
        txt_mem[207] = 32'h7ffe0000;
        txt_mem[208] = 32'h00003fff;
        txt_mem[209] = 32'h87ff8001;
        txt_mem[210] = 32'hffc1fffc;
        txt_mem[211] = 32'h1f01f07f;
        txt_mem[212] = 32'hff003e00;
        txt_mem[213] = 32'h0000001f;
        txt_mem[214] = 32'h003ffc00;
        txt_mem[215] = 32'h1ffc0000;
        txt_mem[216] = 32'h00003fff;
        txt_mem[217] = 32'h87fe0000;
        txt_mem[218] = 32'h7f01fffc;
        txt_mem[219] = 32'h1f01f87f;
        txt_mem[220] = 32'hff003e00;
        txt_mem[221] = 32'h0000001f;
        txt_mem[222] = 32'h000ff000;
        txt_mem[223] = 32'h07f00000;
